...
#ifndef ___bpf_nth2
#define ___bpf_nth2(_, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, _21, \
    _22, _23, _24, N, ...)                                                                                             \
    N
#endif
#ifndef ___bpf_narg2
#define ___bpf_narg2(...)                                                                                              \
    ___bpf_nth2(_, ##__VA_ARGS__, 12, 12, 11, 11, 10, 10, 9, 9, 8, 8, 7, 7, 6, 6, 5, 5, 4, 4, 3, 3, 2, 2, 1, 1, 0)
#endif
    ...
    __builtin_choose_expr(sizeof(t) == 1, 1,                                                                           \
        __builtin_choose_expr(sizeof(t) == 2, 1,                                                                       \
            __builtin_choose_expr(sizeof(t) == 4, 1,                                                                   \
                __builtin_choose_expr(sizeof(t) == 8, 1, __builtin_choose_expr(sizeof(t) == 16, 2, (void)0)))))
...
#define BPF_PROG2(name, args...)                                                                                       \
    ...
    typeof(name(0)) name(unsigned long long *ctx) { return ____##name(ctx ___bpf_ctx_arg(args)); }                     \
    static __always_inline typeof(name(0)) ____##name(unsigned long long *ctx ___bpf_ctx_decl(args))
...
#define BPF_KSYSCALL(name, args...)                                                                                    \
    ...
    {                                                                                                                  \
        ...
        _Pragma("GCC diagnostic push")                                                                                 \
            _Pragma("GCC diagnostic ignored \"-Wint-conversion\"") if (LINUX_HAS_SYSCALL_WRAPPER) return ____##name(   \
                ___bpf_syswrap_args(args));                                                                            \
