...
#define ___bpf_treg_cnt(t)                                                                                                                                                                                                                     \
    __builtin_choose_expr(sizeof(t) == 1, 1, __builtin_choose_expr(sizeof(t) == 2, 1, __builtin_choose_expr(sizeof(t) == 4, 1, __builtin_choose_expr(sizeof(t) == 8, 1, __builtin_choose_expr(sizeof(t) == 16, 2, (void)0)))))
