...
#define bpf_for_each(type, cur, args...)                                                                                                                                                                                                                                                                                                                               \
    for (                                                                                                                                               /* initialize and define destructor */                                                                                                                                                                         \
        struct bpf_iter_##type ___it __attribute__((aligned(8), /* enforce, just in case */, cleanup(bpf_iter_##type##_destroy))),                      /* ___p pointer is just to call bpf_iter_##type##_new() *once* to init ___it */                                                                                                                                \
