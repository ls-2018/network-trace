...
static bool __run_bpf_prog_entry(struct pt_regs *regs) { return !!bpf_prog_run(__ipt_bpf_prog_entry, regs); }

static bool __run_bpf_prog_exit(struct pt_regs *regs) { return !!bpf_prog_run(__ipt_bpf_prog_exit, regs); }

static bool __run_bpf_prog_trace(struct pt_regs *regs) { return !!bpf_prog_run(__ipt_bpf_prog_trace, regs); }
